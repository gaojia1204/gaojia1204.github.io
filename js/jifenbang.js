...
success:function(data){
	...
	for (var i=0;i<data.result.views.jifenbang.length;i++){
		var aaa='<p>'+
			'<span>'+data.result.views.jifenbang[i].c1+'</span>'+
			'<span>'+data.result.views.jifenbang[i].c2+'</span>'+
			'<span>'+data.result.views.jifenbang[i].c3+'</span>'+
			'<span>'+data.result.views.jifenbang[i].c41+'</span>'+
			'<span>'+data.result.views.jifenbang[i].c42+'</span>'+
			'<span>'+data.result.views.jifenbang[i].c43+'</span>'+
			'<span>'+data.result.views.jifenbang[i].c6+'</span>'+
		'</p>';
		$("#sort").append(aaa);
		}
	}
